  ...
  return (
    <section className='choose-us'>
        <div className='choose'>
            ...
            <div className='lock'>
                <img src={icon5} width="83" height="83"/>
                <div>
            ...
            <div className='Money'>
                <img src={icon9} width="83" height="83"/>
                <div>
            ...
            <div className='clean'>
                <img src={icon7} width="83" height="83"/>
                <div>
            ...
            <div className='clock'>
                <img src={icon8} width="83" height="83"/>
                <div>
        ...
        <div className='choose-1'>
            ...
            <img src={bg} width="659" height="424"/>
        </div>
